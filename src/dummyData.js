  ...
  allOffers: [
    {
      ...
      tags: ['City'],
      description: 'Explore the beautiful streets of Venice.',
      price: 455,
    },
    {
      image:
      ...
      description: 'Hike to the summit of the Etna Volcano.',
      price: 110,
    },
    {
      image:
      ...
      tags: ['Vino', 'Explore'],
      description: 'Wine tasting in acient wine cellars.',
      price: 49,
    },
    {
      image:
      ...
      tags: ['Culinary', 'city'],
      description: 'Visit the kitchen of some famous Italian chefs.',
      price: 120,
    },
    {
      image:
      ...
      heading: ['Explore', 'Adventure'],
      description: 'Climb the highest snow capped peaks of Italy.',
      price: 330,
    },
  ],
};
